...
IF(FPROFILE_GENERATE)
  ...
  # Make collection of profile data thread-safe wherever possible
  IF(MY_COMPILER_IS_GNU)
    STRING_APPEND(CMAKE_C_FLAGS " -fprofile-update=atomic")
    STRING_APPEND(CMAKE_CXX_FLAGS " -fprofile-update=atomic")
  ENDIF()
ENDIF()
