...
enum options_client {
  ...
  OPT_LONG_QUERY_TIME,
  OPT_FLASHBACK_DATABASES,
  OPT_FLASHBACK_TABLES,
  OPT_FILTER_TABLES,
  OPT_FILTER_ROWS,
  OPT_QUERY_EVENT_HANDLER,
  OPT_STATEMENT_ERROR,
  OPT_STATEMENT_IGNORE,
  OPT_STATEMENT_IGNORE_FORCE,
  OPT_FLASHBACK_DATABASES_IGNORE,
  OPT_FLASHBACK_TABLES_IGNORE,
  OPT_CONV_EVENT_UPDATE,
  OPT_ENCRYPT_KET_FILE,
