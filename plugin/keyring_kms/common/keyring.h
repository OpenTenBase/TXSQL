...
#include "plugin/keyring_kms/common/keys_container.h"
#include "plugin/keyring_kms/common/keys_iterator.h"
#include "sql/mysqld.h"

using keyring_kms::IKey;
using keyring_kms::IKeyring_io;
using keyring_kms::IKeys_container;
using keyring_kms::ILogger;
...
extern PSI_mutex_key  key_LOCK_kms;
}  // namespace keyring_kms
