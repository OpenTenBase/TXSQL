...
int repl_speedlimit_binlog_dump_start(Binlog_transmit_param *param,
                                      const char *, my_off_t) {
  THD *thd = current_thd;
...
int repl_speedlimit_binlog_dump_end(Binlog_transmit_param *) {
  THD *thd = current_thd;
  speed_monitor.removeSlave(thd);
  return 0;
}

int repl_speedlimit_before_send_event(Binlog_transmit_param *, unsigned char *,
...
SHOW_VAR repl_speed_limit_status_vars[] = {
    {"repl_speed_limit_master_clients", (char *)&SHOW_FNAME(clients), SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"repl_speed_limit_master_sleep_time", (char *)&rpl_speed_limit_sleep_time,
     SHOW_LONGLONG, SHOW_SCOPE_GLOBAL},
    {"repl_speed_limit_master_sleep_count",
     (char *)&rpl_speed_limit_sleep_count, SHOW_LONGLONG, SHOW_SCOPE_GLOBAL},
    {"repl_speed_limit_master_bytes_send", (char *)&rpl_speed_limit_bytes,
     SHOW_LONGLONG, SHOW_SCOPE_GLOBAL},
    {"repl_speed_limit_master_bandwidth", (char *)&rpl_speed_limit_bandwidth,
     SHOW_LONGLONG, SHOW_SCOPE_GLOBAL},
