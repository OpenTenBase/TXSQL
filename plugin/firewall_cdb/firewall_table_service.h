...
class Cursor {
  ...
  */
  bool store_field_values_and_flush(
...
class User_Mode_Cursor : public Cursor {
 public:
  ...
  virtual const char *get_table_name() override { return "cdb_firewall_users"; }
...
class Whitelist_Cursor : public Cursor {
 public:
  ...
  virtual const char *get_table_name() override {
    return "cdb_firewall_whitelist";
  }
