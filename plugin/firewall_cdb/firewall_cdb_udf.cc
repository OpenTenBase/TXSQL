...
extern "C" {
  ...
  bool load_cdb_firewall_userhost_mode_init(UDF_INIT *, UDF_ARGS *, char *message) {
    if (!check_access()) {
  ...
  char *load_cdb_firewall_userhost_mode(UDF_INIT *, UDF_ARGS *, char *, unsigned long *length,
  ...
  bool set_cdb_firewall_userhost_mode_init(UDF_INIT *, UDF_ARGS *args, char *message) {
    if (!check_access()) {
      strcpy(message, "This function requires SUPER_ACL");
      return 1;
    }
  ...
  char *set_cdb_firewall_userhost_mode(UDF_INIT *, UDF_ARGS *args, char *, unsigned long *length,
                                       unsigned char *is_null, unsigned char *) {
  ...
  char *load_cdb_firewall_whitelist(UDF_INIT *, UDF_ARGS *, char *, unsigned long *length,
                                    unsigned char *is_null, unsigned char *) {
  ...
  char *flush_cdb_firewall_whitelist(UDF_INIT *, UDF_ARGS *, char *, unsigned long *length,
                                     unsigned char *is_null, unsigned char *) {
  ...
  bool reload_cdb_firewall_user_rules_init(UDF_INIT *, UDF_ARGS *args, char *message) {
    if (!check_access()) {
      strcpy(message, "This function requires SUPER_ACL");
      return 1;
    }
  ...
  char *cdb_firewall_flush_status(UDF_INIT *, UDF_ARGS *, char *, unsigned long *length,
                                  unsigned char *is_null, unsigned char *) {
