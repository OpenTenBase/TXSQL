...
enum latch_id_t {
  ...
  LATCH_ID_TRX_SYS_MVCC_LOCK,
  LATCH_ID_TRX_SYS_RW_LOCK,
  LATCH_ID_TLOG_FILE_LOCK,
  LATCH_ID_TLOG_PAGE_LOCK,
  LATCH_ID_TLOG_PURGE_LOCK,
  LATCH_ID_TLOG_MGR,
  LATCH_ID_CHECKPOINT,
  LATCH_ID_RSEGS,
  ...
  LATCH_ID_BACKQUERY_ENABLE_LATCH,
  LATCH_ID_ROW_TRUNCATE_LIST,
  LATCH_ID_HOT_UDPATE_MUTEX,
  LATCH_ID_HOT_UDPATE_WAIT_SLOT_MUTEX,
  LATCH_ID_TEST_MUTEX,
