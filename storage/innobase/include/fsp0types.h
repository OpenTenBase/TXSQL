...
/** Width of the flag of encryption algorithm SM4. */
#define FSP_FLAGS_WIDTH_SM4_ALGORITHM 1
...
/** Zero relative shift position of the start of the SM4 ENCRYPTION ALGORITHM bits */
#define FSP_FLAGS_POS_SM4_ALGORITHM \
  (FSP_FLAGS_POS_SDI + FSP_FLAGS_WIDTH_SDI)

/** Zero relative shift position of the start of the UNUSED bits */
#define FSP_FLAGS_POS_UNUSED (FSP_FLAGS_POS_SM4_ALGORITHM + FSP_FLAGS_WIDTH_SM4_ALGORITHM)
...
/** Bit mask of the SM4 ALGORITHM field */
#define FSP_FLAGS_MASK_SM4_ALGORITHM \
  ((~(~0U << FSP_FLAGS_WIDTH_SM4_ALGORITHM)) << FSP_FLAGS_POS_SM4_ALGORITHM)
...
#define FSP_FLAGS_GET_SM4_ALGORITHM(flags) \
  ((flags & FSP_FLAGS_MASK_SM4_ALGORITHM) >> FSP_FLAGS_POS_SM4_ALGORITHM)
