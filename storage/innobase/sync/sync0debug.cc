...
static void sync_latch_meta_init() UNIV_NOTHROW {
  ...
  LATCH_ADD_RWLOCK(TLOG_FILE_LOCK, SYNC_NO_ORDER_CHECK, tlog_file_lock_key);
  LATCH_ADD_RWLOCK(TLOG_PAGE_LOCK, SYNC_NO_ORDER_CHECK, tlog_page_lock_key);
  LATCH_ADD_RWLOCK(TLOG_PURGE_LOCK, SYNC_NO_ORDER_CHECK, tlog_purge_lock_key);
  LATCH_ADD_MUTEX(TLOG_MGR, SYNC_NO_ORDER_CHECK, PFS_NOT_INSTRUMENTED);
