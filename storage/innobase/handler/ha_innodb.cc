...
#define ASYNC_TRUNCATE_SIZE_MIN 32
...
static SHOW_VAR innodb_status_variables[] = {
    ...
    {"buffer_pool_write_requests",
     ...
     SHOW_SCOPE_GLOBAL},
    {"change_buffer_state",
     (char *)&export_vars.innodb_change_buffer_state, SHOW_LONG,
      SHOW_SCOPE_GLOBAL},
...
static int innodb_init(void *p) {
  ...
  innobase_hton->flags = HTON_SUPPORTS_EXTENDED_KEYS |
                         ...
                         HTON_SUPPORTS_TABLE_ENCRYPTION | HTON_SUPPORTS_COMPRESSED_COLUMNS;
...
static byte *innodb_fill_old_vcol_val(row_prebuilt_t *prebuilt,
  ...
  if (o_len != UNIV_SQL_NULL) {
    buf = row_mysql_store_col_in_innobase_format(
        ...
        dict_table_is_comp(prebuilt->table), false, 0, nullptr);
  } else {
...
static int innodb_async_drop_tmp_dir_validate(THD *thd, SYS_VAR *var,
  ...
  nullptr. */
  if (dest_dir && !check_async_drop_tmp_dir(thd, dest_dir)) {
...
static MYSQL_SYSVAR_ULONG(
    ...
    innodb_async_truncate_size_validate, NULL,
    128,                                            /* Default setting */
...
static MYSQL_SYSVAR_ULONG(
    ...
    innodb_async_table_size_validate, NULL, 2048, /* Default setting */
...
static MYSQL_SYSVAR_ENUM(
    ...
    "flushes; "
    "BACKOFF: Wait until lru manger produces a free page.",
