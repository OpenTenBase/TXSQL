...
public class SM4CBCEnCryptActivity extends BaseToolbarActivity implements View.OnClickListener{
    ...
    public static Intent getStartIntent(Context context, String backtxt, String desc) {
        Intent intent = new Intent(context, SM4CBCEnCryptActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.cbc_encrypt));
        ...
        //iv
        mDataItems.add(getString(R.string.iv_vector));
        iv_vector = Utils.getRandombytes(16);
    ...
    public void onClick(View v) {
        ...
        if(id == R.id.b_bottom) {
            if(mCiphers != null) {
                startActivity(SM4CBCDecryptActivity.getStartIntent(this, getString(R.string.cbc_encrypt), mDesc, mCiphers, iv_vector));
            }
        } else {
            reEncrypt();
        }
    ...
    private void reEncrypt() {
        ...
        byte[] cipher = smutils.SM4CBCEncrypt(str.getBytes(), Utils.string2bytes(symnkey),iv_vector);
        if(cipher == null) {
    ...
    private class myAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            synchronized (SM4CBCEnCryptActivity.this) {
