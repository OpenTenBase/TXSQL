...
public class DestroySM2KeyActivity extends BaseToolbarActivity implements View.OnClickListener{
    private SMKeyManager keymanager;
    private EditText et_top;

    public static Intent getStartIntent(Context context, String backtxt) {
        Intent intent = new Intent(context, DestroySM2KeyActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getText(R.string.del_keypair));
