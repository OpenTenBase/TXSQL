...
public class SMUtils {
    ...
    private SMUtils(Context context) {
    ...
    public native int     SM4GCMEncrypt(byte[] in, byte[] key,
                                        byte[] iv, byte[] aad,
                                        byte[][] outdata);

    public native int     SM4GCMDecrypt(byte[] in, byte[] key,
                                        byte[] iv, byte[] aad, byte[] tag,
                                        byte[][] outdata);
    public native int     SM4GCMEncryptNoPadding(byte[] in, byte[] key,
                                                 byte[] iv, byte[] aad,
                                                 byte[][] outdata);
    public native int     SM4GCMDecryptNoPadding(byte[] in, byte[] key,
                                             byte[] iv, byte[] aad, byte[] tag,
                                             byte[][] outdata);
