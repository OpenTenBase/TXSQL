...
#define TENCENTSM_VERSION ("1.7.3-1")
...
/**
* @brief 基于sm3算法从共享数据派生出密钥
* @param share  函数入参 - 共享数据
* @param sharelen 函数入参 - 共享数据长度，不可大于1024字节
* @param outkey 函数出参 - 密钥
* @param keylen 函数入参 - 密钥长度
* @return 0 -- OK
*/
...
/**
SM4 GCM模式对称加解密。加密，使用PKCS7填充，实际上GCM模式可不填充，非短明文加密推荐使用SM4_GCM_Encrypt_NoPadding_NIST_SP800_38D替代。
@param in  函数入参 - 明文
@param inlen  函数入参 - 明文长度
@param out  函数出参 - 密文
@param outlen  函数出参 - 密文长度
