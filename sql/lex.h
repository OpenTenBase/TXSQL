...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM("ADD", ADD)},
    {SYM("ADMIN", ADMIN_SYM)},
    {SYM("AES128", AES128_SYM)},
    {SYM("AES192", AES192_SYM)},
    {SYM("AES256", AES256_SYM)},
    {SYM("AFTER", AFTER_SYM)},
    {SYM("AGAINST", AGAINST)},
    ...
    {SYM("CYCLE", CYCLE_SYM)},
    {SYM("CDB_SQL_FILTERS", SQL_CDB_FILTER_SYM)},
    {SYM("CDB_OUTLINE_INFO", CDB_OUTLINE_INFO_SYM)},
    {SYM("CDB_STATISTICS_TASKS", STATISTICS_TASKS_SYM)},
    {SYM("CDB_STATISTICS_NODE", STATISTICS_NODE_SYM)},
    {SYM("DATA", DATA_SYM)},
    ...
    {SYM("NEXT", NEXT_SYM)},
    {SYM("NO", NO_SYM)},
    {SYM("NOCACHE", NOCACHE_SYM)},
    {SYM("NOCYCLE", NOCYCLE_SYM)},
    {SYM("NOMAXVALUE", NOMAXVALUE_SYM)},
    {SYM("NOMINVALUE", NOMINVALUE_SYM)},
    {SYM("NO_WAIT", NO_WAIT_SYM)},
    {SYM("NOWAIT", NOWAIT_SYM)},
    {SYM("NODEGROUP", NODEGROUP_SYM)},
    {SYM("NONE", NONE_SYM)},
    {SYM("NOORDER", NOORDER_SYM)},
    {SYM("NOT", NOT_SYM)},
    ...
    {SYM("OUTER", OUTER_SYM)},
    {SYM("OUTFILE", OUTFILE)},
    {SYM("OUTLINE", OUTLINE_SYM)},
    {SYM("OUTLINE_INFO", OUTLINE_INFO_SYM)},
    {SYM("OVER", OVER_SYM)},
    {SYM("OWNER", OWNER_SYM)},
    ...
    {SYM("TDSQL_CACHE", TDSQL_CACHE_SYM)},
    {SYM("TDSQL_CYCLE", TDSQL_CYCLE_SYM)},
    {SYM("TDSQL_MAXVALUE", TDSQL_MAXVALUE_SYM)},
    {SYM("TDSQL_MINVALUE", TDSQL_MINVALUE_SYM)},
    {SYM("TDSQL_NOCACHE", TDSQL_NOCACHE_SYM)},
    {SYM("TDSQL_NOCYCLE", TDSQL_NOCYCLE_SYM)},
    {SYM("TDSQL_NOMAXVALUE", TDSQL_NOMAXVALUE_SYM)},
    {SYM("TDSQL_NOMINVALUE", TDSQL_NOMINVALUE_SYM)},
    {SYM("TDSQL_NOORDER", TDSQL_NOORDER_SYM)},
    {SYM("TDSQL_INCREMENT", TDSQL_INCREMENT_SYM)},
    {SYM("TDSQL_ORDER", TDSQL_ORDER_SYM)},
    {SYM("TDSQL_SEQUENCE", TDSQL_SEQUENCE_SYM)},
    {SYM("TDSQL_SETVAL", TDSQL_SETVAL_SYM)},
    {SYM("TDSQL_TLOG", TDSQL_TLOG_SYM)},
    {SYM("TDSQL_WITHGTS", TDSQL_WITHGTS_SYM)},
    {SYM("TDSQL_TIMEOUT_TRXS", TDSQL_TIMEOUT_TRXS_SYM)},
    ...
    {SYM("TXSQL_RETURNING", TXSQL_RETURNING_SYM)},
    {SYM("TYPE", TYPE_SYM)},
    {SYM("TYPES", TYPES_SYM)},
    ...
    */
    ...
    {SYM_H("SORT_MERGE_JOIN", SORT_MERGE_JOIN_HINT)},
    {SYM_H("NO_SORT_MERGE_JOIN", NO_SORT_MERGE_JOIN_HINT)},
    {SYM_H("REMAP_SUBPARTITION_OUTLINE", REMAP_SUBPARTITION_OUTLINE_HINT)},
