...
enum column_format_type {
  ...
  COLUMN_FORMAT_TYPE_COMPRESSED = 4 /* COMPRESSED format */
};
...
private:
 ...
 public:
  bool is_flag_set(uint64 flag) const { return flags & flag; }
  void set_flag(uint64 flag) { flags |= flag; }
  void clear_flag(uint64 flag) { flags &= ~flag; }
  // Avoid using this function as it makes it harder to change the internal
  // representation.
  uint64 all_flags() const { return flags; }
