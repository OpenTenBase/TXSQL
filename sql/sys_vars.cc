...
static Sys_var_ulong Sys_log_error_verbosity(
    ...
    "4, log errors, warnings, notes and tips "
...
static Sys_var_bool Sys_threadpool_oversubscribeParall(
    ...
    GLOBAL_VAR(thread_pool_oversubscribe_parall),
    CMD_LINE(OPT_ARG), DEFAULT(true));
...
static Sys_var_ulonglong Sys_binlog_write_threshold(
    "binlog_write_threshold", "The max allowed size (in bytes) of the transactional and"
