...
SHOW_VAR com_status_vars[] = {
    ...
    {"check", (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_CHECK]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"check_index",
     (char*)offsetof(System_status_var, com_stat[(uint)SQLCOM_CHECK_INDEX]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"checksum",
    ...
    {"optimize",
     ...
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"parse",
     (char*) offsetof(System_status_var, com_stat[(uint) SQLCOM_PARSE_STATEMENT]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"preload_keys",
...
SHOW_VAR status_vars[] = {
    ...
    {"Handler_read_rnd_next",
     ...
     SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
    {"Txsql_implicit_convert_to_count_star",
     (char *)offsetof(System_status_var, txsql_implicit_convert_to_count_zero),
      SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
    {"Txsql_total_count_function",
     (char *)offsetof(System_status_var, txsql_total_count_function),
      SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
...
bool g_txsql_enable_name_ack = false;
