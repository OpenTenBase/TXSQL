...
/*
  Query id is generated by proxy, and send as a hint in front of normal SQL
  queries.

  qid = proxyid + ":" + connection_id + "-" + qid_prefix + "-" + qid_sequence
        (uint_32)       (uint_32)             (ulong)            (ulong)
  So, max_length = 10 + 1 + 10 + 1 + 20 + 1 + 20 + len('\0') = 64.
 */
#define TXSQL_QID_MAX_LENGTH 64
