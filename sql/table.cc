...
/* RECYCLE_BIN_SCHEMA name before 8030 */
LEX_CSTRING ORIGINA_RECYCLE_BIN_SCHEMA_NAME = {STRING_WITH_LEN("__cdb_recycle_bin__")};

/* RECYCLE_BIN_SCHEMA name from 8030 */
LEX_CSTRING NEW_RECYCLE_BIN_SCHEMA_NAME = {STRING_WITH_LEN("__txsql_recycle_bin__")};

/* RECYCLE_BIN_SCHEMA name */
LEX_CSTRING RECYCLE_BIN_SCHEMA_NAME = NEW_RECYCLE_BIN_SCHEMA_NAME;
