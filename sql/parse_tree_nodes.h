...
class PT_delete final : public Parse_tree_root {
 private:
  ...
  PT_select_var_list *opt_select_var_list;
 ...
 public:
  ...
  PT_delete(PT_with_clause *with_clause_arg, PT_hint_list *opt_hints_arg,
            ...
            PT_select_var_list *select_var_list_arg)
      : m_with_clause(with_clause_arg),
        ...
        opt_select_var_list(select_var_list_arg) {
...
class PT_show_processlist final : public PT_show_base {
 public:
  // Unconditional parallel parameter since required by sql_yacc.yy
  PT_show_processlist(const POS &pos, bool verbose, bool detail,
                      bool parallel MY_ATTRIBUTE((unused)))
  : PT_show_base(pos, SQLCOM_SHOW_PROCESSLIST),
          m_sql_cmd(verbose, detail
#if defined(HAVE_PX)
                    ,
                    parallel
#endif
