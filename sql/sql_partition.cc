...
bool fix_partition_func(THD *thd, TABLE *table, bool is_create_table_ind) {
  ...
  */
  ...
  if (((part_info->part_type != partition_type::HASH ||
       ...
       check_part_func_fields(part_info->part_field_array, true) && part_info->isNotTDSQLTable() ) ||
      (part_info->list_of_subpart_fields == false &&
       part_info->is_sub_partitioned() &&
       check_part_func_fields(part_info->subpart_field_array, true) &&  part_info->isNotTDSQLTable() )) {
    /*
