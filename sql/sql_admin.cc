  ...
  for (const auto &pair : results) {
    ...
    switch (pair.second) {
      ...
      case histograms::Message::JSON_UNSUPPORTED_CHARSET:
        message_type.assign("Error");
        message.assign("The charest id does not exists at '");
        message.append(pair.first);
        message.append("'.");
        break;
      ...
      case histograms::Message::JSON_INVALID_NUM_DISTINCT:
        message_type.assign("Error");
        message.assign(
            "The number of distinct value must be a positive integer at '");
        message.append(pair.first);
        message.append("'.");
        break;
      ...
      case histograms::Message::JSON_VALUE_NOT_ASCENDING_1:
        message_type.assign("Error");
        message.assign(
            "The value must be greater than that of previous bucket at '");
        message.append(pair.first);
        message.append("'.");
        break;
      case histograms::Message::JSON_VALUE_NOT_ASCENDING_2:
        message_type.assign("Error");
        message.assign(
            "The lower inclusive value of a bucket must be greater than the "
            "upper inclusive value of previous bucket at '");
        message.append(pair.first);
        message.append("'.");
        break;
      case histograms::Message::JSON_VALUE_DESCENDING_IN_BUCKET:
        message_type.assign("Error");
        message.assign(
            "The lower inclusive value of a bucket must be less than or equal "
            "to upper inclusive value at '");
        message.append(pair.first);
        message.append("'.");
        break;
      case histograms::Message::JSON_CUMULATIVE_FREQUENCY_NOT_ASCENDING:
        message_type.assign("Error");
        message.assign(
            "The cumulative frequency must be greater than that of previous "
            "bucket at '");
        message.append(pair.first);
        message.append("'.");
        break;
      case histograms::Message::JSON_INVALID_TOTAL_FREQUENCY:
        ...
        message.assign(
            ...
            "of the last bucket should be 1 or 0.'");
        break;
