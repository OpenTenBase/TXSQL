...
#ifndef RPL_RELOAD_CACHE_INCLUDED
#define RPL_RELOAD_CACHE_INCLUDED
...
*/
enum Reload_type { RELOAD_STATEMENT_OUTLINE = 0, RELOAD_ENTRY_COUNT};
...
*/
void mark_rli_trx_reload(THD *thd, Relay_log_info *rli,
