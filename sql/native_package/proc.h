...
class Proc : public PSI_memory_base {
  ...
  */
  ...
  /**
    ...
    @retval       Sql cmd
  */
  virtual Sql_cmd *evoke_cmd(THD *thd, mem_root_deque<Item *> *items) const = 0;
...
class Sql_cmd_proc : public Sql_cmd {
 ...
 public:
  explicit Sql_cmd_proc(THD *thd, mem_root_deque<Item *> *items,
                        const Proc *proc, Priv_type priv_type)
      : m_thd(thd), m_items(items), m_proc(proc), m_priv_type(priv_type) {}
  /**
...
class Sql_cmd_admin_proc : public Sql_cmd_proc {
 public:
  explicit Sql_cmd_admin_proc(THD *thd, mem_root_deque<Item *> *items,
                              const Proc *proc)
      : Sql_cmd_proc(thd, items, proc, Priv_type::PRIV_SUPER_ACL) {}
...
class Sql_cmd_trans_proc : public Sql_cmd_proc {
 public:
  explicit Sql_cmd_trans_proc(THD *thd, mem_root_deque<Item *> *items,
                              const Proc *proc)
      : Sql_cmd_proc(thd, items, proc, Priv_type::PRIV_NONE_ACL) {}
