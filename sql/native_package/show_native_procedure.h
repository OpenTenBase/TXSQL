...
class Sql_cmd_show_native_procedure : public Sql_cmd_admin_proc {
 public:
  explicit Sql_cmd_show_native_procedure(THD *thd,
                                         mem_root_deque<Item *> *items,
                                         const Proc *proc)
      : Sql_cmd_admin_proc(thd, items, proc) {}
  /**
...
class Show_native_procedure_proc : public Proc, public Disable_copy_base {
  ...
  */
  virtual Sql_cmd *evoke_cmd(THD *thd, mem_root_deque<Item *> *items) const override;
