...
#ifndef NDEBUG
    snprintf (tmpbuf , sizeof(tmpbuf) , "-v18-txsql-2.0.1-V2.0R752D001-%04d%02d%02d-%02d%02d" , CUR_YEAR , CUR_MONTH , CUR_DAY , CUR_HOUR , CUR_MIN);
#else
    snprintf (tmpbuf , sizeof(tmpbuf) , "-v18-txsql-2.0.1-V2.0R752D001-%04d%02d%02d" , CUR_YEAR , CUR_MONTH , CUR_DAY);
#endif
    return tmpbuf;
}
