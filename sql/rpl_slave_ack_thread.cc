...
/*
compile failed
/data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.cc:36:12: error: default argument given for parameter 3 of ‘int flush_master_info(Master_info*, bool, bool, bool, bool)’ [-fpermissive]
   36 | extern int flush_master_info(Master_info *mi, bool force, bool need_lock = true,
      |            ^~~~~~~~~~~~~~~~~
In file included from /data2/mywork/txsql/8.0/normal-30-3/sql/sql_class.h:116,
                 from /data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.h:14,
                 from /data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.cc:8:
/data2/mywork/txsql/8.0/normal-30-3/sql/rpl_replica.h:483:5: note: previous specification in ‘int flush_master_info(Master_info*, bool, bool, bool, bool)’ here
  483 | int flush_master_info(Master_info *mi, bool force, bool need_lock = true,
      |     ^~~~~~~~~~~~~~~~~
/data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.cc:36:12: error: default argument given for parameter 4 of ‘int flush_master_info(Master_info*, bool, bool, bool, bool)’ [-fpermissive]
   36 | extern int flush_master_info(Master_info *mi, bool force, bool need_lock = true,
      |            ^~~~~~~~~~~~~~~~~
In file included from /data2/mywork/txsql/8.0/normal-30-3/sql/sql_class.h:116,
                 from /data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.h:14,
...
/data2/mywork/txsql/8.0/normal-30-3/sql/rpl_replica.h:483:5: note: previous specification in ‘int flush_master_info(Master_info*, bool, bool, bool, bool)’ here
  483 | int flush_master_info(Master_info *mi, bool force, bool need_lock = true,
      |     ^~~~~~~~~~~~~~~~~
/data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.cc:36:12: error: default argument given for parameter 5 of ‘int flush_master_info(Master_info*, bool, bool, bool, bool)’ [-fpermissive]
   36 | extern int flush_master_info(Master_info *mi, bool force, bool need_lock = true,
      |            ^~~~~~~~~~~~~~~~~
In file included from /data2/mywork/txsql/8.0/normal-30-3/sql/sql_class.h:116,
                 from /data2/mywork/txsql/8.0/normal-30-3/sql/rpl_slave_ack_thread.h:14,
...
void rpl_slave_ack_thread::flush_and_ack(
  ...
  if (likely(mi)) {
    ...
    if (likely(!error)) {
      ...
      if (flush_master_info(mi, true, false, false, false)) {
